...
; Alfred Correira for much usefクラス名ul feedback. Alf-Ivar Holm also contributed
; patches.
...
(defvar cssm-font-lock-keywords
  (list
   ...
   (cons "\\.[a-zA-Z][-_a-zA-Z0-9.]+" font-lock-variable-name-face)
   ...
   (cons "#[-_a-zA-Z0-9]*" font-lock-function-name-face)
